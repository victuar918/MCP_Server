...
async function execBTR(n,a){
  ...
  if(!tok&&!['btr_init_candidate_slots','btr_consensus_analyzer','btr_conflict_axis_finder','validate_sclass_gate','video_init_sheets','video_create_script','video_read_script','video_update_row_status','video_delete_script','video_write_safe','video_verify_script'].includes(n))return{error:'Google 인증 실패'};
...
app.get('/',(_req,res)=>res.json({
  status:'running',server:'ASTERION AI Evolution Engine v5.21',
